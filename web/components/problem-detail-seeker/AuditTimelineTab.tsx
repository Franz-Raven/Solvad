...
function DayGroup({
  ...
  return (
    <div className="overflow-visible">
      ...
      >
        {/* Node on the spine */}
        <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 z-10 ring-2 ring-white ring-offset-0 shadow-md bg-white group-hover:shadow-lg transition-all">
