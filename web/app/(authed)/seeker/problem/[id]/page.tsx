...
const STATUS_DESCRIPTIONS: Record<string, string> = {
  ...
  SOLVED_OPEN_FOR_IMPROVEMENT:
    "The problem will be marked as solved but remain visible so solvers can continue to improve upon it.",
  COMPLETED:
    "The problem will be marked as fully completed and hidden from the solver browse page.",
  CLOSED:
    "The problem will be hidden from all solvers. You can reopen it later.",
};
...
export default function ProblemDetailPage() {
  ...
  const [modalMode, setModalMode] = useState<"confirm" | "terminate" | null>(
    null,
  );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-accent/20 via-background to-accent/10 overflow-visible">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 mb-6">
                <p className="text-sm text-gray-600 text-center">
                  {STATUS_DESCRIPTIONS[pendingStatus] ??
                    "This will update the visibility and state of your problem."}
                </p>
              </div>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/65 backdrop-blur-md">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md border border-gray-200 p-6">
              ...
              <h2 className="text-lg font-bold text-gray-900 text-center mb-2">
                ⚠️ Active Solver Warning
              </h2>
              <p className="text-sm text-gray-600 text-center mb-4">
                A solver is <strong>currently working</strong> on this problem.
                ...
                <span className="text-red-600 font-semibold">
                  terminate their active attempt
                </span>
                .
              </p>
              <div className="bg-red-50 border border-red-200 rounded-lg px-4 py-3 mb-6 space-y-1">
                ...
                <ul className="text-xs text-red-700 space-y-0.5 list-disc list-inside">
                  <li>
                    End their attempt and mark it as <strong>Terminated</strong>
                  </li>
              ...
              <div className="flex gap-3">
                ...
                >
                  Yes, Terminate &{" "}
                  {pendingStatus === "COMPLETED" ? "Complete" : "Close"}
                </button>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-8 py-8 overflow-visible">
        ...
        {activeTab === "proposals" && (
          <ProposalsTab problemId={problemId} />
        )}{" "}
        {/* <-- ADD THIS LINE */}
